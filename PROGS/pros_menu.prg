...
* DEFINE PAD _8 OF XMFORM say  defauserid
...
* ON PAD _8 OF XMFORM ACTIVATE POPUP defauserid
 ...
 DEFINE BAR 4 OF XMASTER PROMPT 'Jenis Penggunaan' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 4 OF XMASTER DO FORM setsandi WITH "P005","TAMPIL" 
 DEFINE BAR 5 OF XMASTER PROMPT 'Sektor Ekonomi' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 5 OF XMASTER DO FORM setsandi WITH "P006","TAMPIL" 
 DEFINE BAR 6 OF XMASTER PROMPT 'Sumber Pelunasan' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 6 OF XMASTER DO FORM setsandi WITH "P007","TAMPIL" 
 DEFINE BAR 7 OF XMASTER PROMPT '\-'
 DEFINE BAR 8 OF XMASTER PROMPT '---- SMB/Simpanan-----' STYLE 'BI' SKIP COLOR SCHEME 3
 ...
 DEFINE BAR 10 OF XMASTER PROMPT 'Cara Perhitungan '	SKIP COLOR SCHEME 3
 * ON SELECTION BAR 10 OF XMASTER DO FORM setsandi WITH "S002","TAMPIL"  
 DEFINE BAR 11 OF XMASTER PROMPT 'Kelompok Simpanan' SKIP COLOR SCHEME 3
 * ON SELECTION BAR 11 OF XMASTER DO FORM setsandi WITH "S003","TAMPIL"
 ...
 DEFINE BAR 22 OF XMASTER PROMPT 'Daftar Resort' STYLE 'BI' SKIP COLOR SCHEME 3
 * ON SELECTION BAR 22 OF XMASTER DO FORM setsandi WITH "P003","TAMPIL" 
 DEFINE BAR 23 OF XMASTER PROMPT 'Wilayah Pinjaman'  STYLE 'BI' SKIP COLOR SCHEME 3
* ON SELECTION BAR 23 OF XMASTER DO FORM setsandi WITH "P004","TAMPIL"        
 DEFINE BAR 24 OF XMASTER PROMPT 'Daftar Notaris'  STYLE 'BI' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 24 OF XMASTER DO FORM setsandi WITH "P013","TAMPIL" 
 DEFINE BAR 25 OF XMASTER PROMPT 'Daftar Asuransi'  STYLE 'BI' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 25 OF XMASTER DO FORM setsandi WITH "P014","TAMPIL" 
 DEFINE BAR 26 OF XMASTER PROMPT 'Kode Marketing'  STYLE 'BI' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 26 OF XMASTER DO FORM setsandi WITH "A001","TAMPIL"
 DEFINE BAR 27 OF XMASTER PROMPT 'Kode Kota'  STYLE 'BI' SKIP COLOR SCHEME 3
 *ON SELECTION BAR 27 OF XMASTER DO FORM setsandi WITH "A002","TAMPIL"
 ...
 DEFINE BAR 1 OF XPRODUK PROMPT 'Produk Simpata/Tabungan' 
 DEFINE BAR 2 OF XPRODUK PROMPT 'Produk Simpanan Berjangka'
 DEFINE BAR 3 OF XPRODUK PROMPT 'Modal Penyertaan'  STYLE 'BI' SKIP COLOR SCHEME 3
 ...
 *ON SELECTION BAR 3 OF XPRODUK DO FORM setsandi WITH "S01C","TAMPIL"
 ...
 DEFINE BAR 6 OF XTRANSAKSI PROMPT 'Data History Pinjaman' SKIP FOR  ;
       .NOT. IJINMODUL('PINJ','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 6 OF XTRANSAKSI DO FORM pinjaman WITH "TAMPIL","P"  
 DEFINE BAR 7 OF XTRANSAKSI PROMPT 'Data Debius Pinjaman' SKIP FOR  ;
       .NOT. IJINMODUL('PINJ','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 7 OF XTRANSAKSI DO FORM pinjaman WITH "TAMPIL","D"  
 ...
 DEFINE BAR 10 OF XTRANSAKSI PROMPT 'Daftar Simpanan Manasuka Berjangka ' SKIP FOR  ;
       .NOT. IJINMODUL('SIMP','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 10 OF XTRANSAKSI DO FORM simpanan WITH "TAMPIL","A","2" && 002 > 1 
 DEFINE BAR 11 OF XTRANSAKSI PROMPT 'Data History S M B' SKIP FOR  ;
       .NOT. IJINMODUL('SIMP','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 11 OF XTRANSAKSI DO FORM simpanan WITH "TAMPIL","B"
 DEFINE BAR 12 OF XTRANSAKSI PROMPT ' Daftar Simpata ' SKIP FOR  ;
       .NOT. IJINMODUL('SIMP','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 12 OF XTRANSAKSI DO FORM simpanan WITH "TAMPIL","S","1" && 002 > 2 
 DEFINE BAR 13 OF XTRANSAKSI PROMPT ' Data History Simpata ' SKIP FOR  ;
       .NOT. IJINMODUL('SIMP','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 13 OF XTRANSAKSI DO FORM simpanan WITH "TAMPIL","D" 
 ...
 DEFINE BAR 22 OF XTRANSAKSI PROMPT 'Daftar Inventaris ' SKIP FOR  ;
       .NOT. IJINMODUL('AKT','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 22 OF XTRANSAKSI DO FORM gl_inventaris with "TAMPIL", "A"
 DEFINE BAR 23 OF XTRANSAKSI PROMPT 'History Inventaris' SKIP FOR  ;
       .NOT. IJINMODUL('AKT','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 23 OF XTRANSAKSI DO FORM gl_inventaris with "TAMPIL", "H"
 DEFINE BAR 24 OF XTRANSAKSI PROMPT '\----'
 DEFINE BAR 25 OF XTRANSAKSI PROMPT 'Kolektor' STYLE 'BI' SKIP COLOR SCHEME 3
...
*!*	 ON SELECTION BAR 25 OF XTRANSAKSI DO FORM instansi_masuk
 ...
 DEFINE BAR 26 OF XTRANSAKSI PROMPT 'Pembayaran Kolektor' SKIP FOR  ;
       .NOT. IJINMODUL('COL','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 26 OF XTRANSAKSI DO FORM Col1_masuk
  DEFINE BAR 27 OF XTRANSAKSI PROMPT '\----'
  DEFINE BAR 28 OF XTRANSAKSI PROMPT 'Jaminan / Agunan' STYLE 'BI' SKIP COLOR SCHEME 3
  DEFINE BAR 29 OF XTRANSAKSI PROMPT 'Agunan BPKB ' SKIP FOR  ;
       .NOT. IJINMODUL('COL','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 29 OF XTRANSAKSI DO FORM agunan_bpkb
 
 DEFINE BAR 30 OF XTRANSAKSI PROMPT 'Agunan STPK' SKIP FOR  ;
       .NOT. IJINMODUL('COL','VIEW') COLOR SCHEME 3
 ON SELECTION BAR 30 OF XTRANSAKSI DO FORM agunan_sertifikat
 ...
 DEFINE BAR 2 OF XREPORT PROMPT 'Laporan S M B ' COLOR SCHEME 3 PICTURE  '.\image\bank 4 add.png'
 ...
 DEFINE BAR 7 OF XREPORT PROMPT 'Laporan Simpata' COLOR SCHEME 3
 ...
 DEFINE BAR 4 OF XLAPANGGOTA PROMPT '4. Laporan Mutasi Simpanan SWK'
 DEFINE BAR 5 OF XLAPANGGOTA PROMPT '5. Laporan Mutasi Simpanan Lain 2'
 DEFINE BAR 6 OF XLAPANGGOTA PROMPT '6. Laporan Mutasi Simpanan SHU' 
 DEFINE BAR 7 OF XLAPANGGOTA PROMPT '7. Laporan Rincian SHU'
 DEFINE BAR 8 OF XLAPANGGOTA PROMPT '8. Laporan Anggota Keluar'
 DEFINE BAR 9 OF XLAPANGGOTA PROMPT '9. Tanda Terima SHU'
 DEFINE BAR 10 OF XLAPANGGOTA PROMPT '10. Laporan anggota Baru'
 DEFINE BAR 11 OF XLAPANGGOTA PROMPT '11. Laporan Nominatif Simpanan Pokok'
 DEFINE BAR 12 OF XLAPANGGOTA PROMPT '12. Laporan Nominatif Simpanan Wajib'
 DEFINE BAR 13 OF XLAPANGGOTA PROMPT '13. Laporan Nominatif Simpanan SWK'
 DEFINE BAR 14 OF XLAPANGGOTA PROMPT '14. Laporan Nominatif Simpanan Lain 2'
 DEFINE BAR 15 OF XLAPANGGOTA PROMPT '15. Laporan Nominatif Simpanan SHU'
 DEFINE BAR 16 OF XLAPANGGOTA PROMPT '16. Laporan Nominatif Simpanan Anggota'
  
 ON SELECTION BAR 1 OF XLAPANGGOTA do form angg_lap with 16
 ON SELECTION BAR 2 OF XLAPANGGOTA do form angg_lap with 3
 ON SELECTION BAR 3 OF XLAPANGGOTA do form angg_lap with 4
 ON SELECTION BAR 4 OF XLAPANGGOTA do form angg_lap with 7
 ON SELECTION BAR 5 OF XLAPANGGOTA do form angg_lap with 8
 ON SELECTION BAR 6 OF XLAPANGGOTA do form angg_lap with 9
 
 ON SELECTION BAR 7 OF XLAPANGGOTA do form angg_lap with 2
 ON SELECTION BAR 8 OF XLAPANGGOTA do form angg_lap with 5
 ON SELECTION BAR 9 OF XLAPANGGOTA do form angg_lap with 6
 ON SELECTION BAR 10 OF XLAPANGGOTA do form angg_lap with 10
 ON SELECTION BAR 11 OF XLAPANGGOTA do form angg_lap with 11
 ON SELECTION BAR 12 OF XLAPANGGOTA do form angg_lap with 12
 ON SELECTION BAR 13 OF XLAPANGGOTA do form angg_lap with 13
 ON SELECTION BAR 14 OF XLAPANGGOTA do form angg_lap with 14
 ON SELECTION BAR 15 OF XLAPANGGOTA do form angg_lap with 15
 ON SELECTION BAR 16 OF XLAPANGGOTA do form angg_lap with 1
 ...
 DEFINE BAR 2 OF XLAPSIMPANAN PROMPT '2. Laporan Mutasi SMB'
 DEFINE BAR 3 OF XLAPSIMPANAN PROMPT '3. Laporan Nominatif SMB'
 DEFINE BAR 4 OF XLAPSIMPANAN PROMPT '4. Laporan Penutupan Rekening'
 DEFINE BAR 5 OF XLAPSIMPANAN PROMPT '5. Laporan Rekap Buku Besar'
 DEFINE BAR 6 OF XLAPSIMPANAN PROMPT '6. Laporan SMB Per Resort '
 DEFINE BAR 7 OF XLAPSIMPANAN PROMPT '7. Laporan Mutasi Saldo'
 DEFINE BAR 8 OF XLAPSIMPANAN PROMPT '8. Laporan Pengambilan SMB'
 ON SELECTION BAR 1 OF XLAPSIMPANAN do form simp_lap with 1,2
 ON SELECTION BAR 2 OF XLAPSIMPANAN do form simp_lap with 22,2
 ON SELECTION BAR 3 OF XLAPSIMPANAN do form simp_lap with 3,2
 ON SELECTION BAR 4 OF XLAPSIMPANAN do form simp_lap with 4,2
 ON SELECTION BAR 5 OF XLAPSIMPANAN do form simp_lap with 9,2  && 5 aslinya
 ...
 DEFINE BAR 5 OF XLAPPINJAMAN PROMPT '5. Laporan Tentang Agunan'
 DEFINE BAR 6 OF XLAPPINJAMAN PROMPT '6. Laporan Tunggakan Angsuran '
 DEFINE BAR 7 OF XLAPPINJAMAN PROMPT '7. Laporan Angsuran Menurut Realisasi'
 DEFINE BAR 8 OF XLAPPINJAMAN PROMPT '8. Laporan Pinjaman Belum Cair'
 DEFINE BAR 9 OF XLAPPINJAMAN PROMPT '9. Laporan Non Performing Loan (NPL)'
 DEFINE BAR 10 OF XLAPPINJAMAN PROMPT '10. Laporan Nasabah turun bunga '
 DEFINE BAR 11 OF XLAPPINJAMAN PROMPT '11. Laporan Pinjaman Debius '
 DEFINE BAR 12 OF XLAPPINJAMAN PROMPT '12. Laporan Penerimaan Angsuran Debius '
 DEFINE BAR 13 OF XLAPPINJAMAN PROMPT '13. Laporan Nominatif Pinjaman Debius '
 DEFINE BAR 14 OF XLAPPINJAMAN PROMPT '14. Laporan Pelunasan Pinjaman Debius'
 DEFINE BAR 15 OF XLAPPINJAMAN PROMPT '15. Laporan Nominatif Pinjaman 2'
 DEFINE BAR 16 OF XLAPPINJAMAN PROMPT '16. Laporan Nominatif Pinjaman 3'
 DEFINE BAR 17 OF XLAPPINJAMAN PROMPT '17. Laporan Kurang Lebih Jasa Lunas'
 
*!*	 DEFINE BAR 11 OF XLAPPINJAMAN PROMPT '11. Laporan Saldo Agunan '
*!*	 
 ...
 ON BAR 5 OF XLAPPINJAMAN ACTIVATE POPUP XLAPPINJ_JMN
 DEFINE POPUP XLAPPINJ_JMN COLOR SCHEME 5 SHADOW MARGIN RELATIVE 
 DEFINE BAR 1 OF XLAPPINJ_JMN PROMPT '1. Laporan Agunan Masuk '
 DEFINE BAR 2 OF XLAPPINJ_JMN PROMPT '2. Laporan Agunan Keluar'
 DEFINE BAR 3 OF XLAPPINJ_JMN PROMPT '3. Laporan Saldo Agunan '
 DEFINE BAR 4 OF XLAPPINJ_JMN PROMPT '4. Laporan Jaminan Kosong'
 DEFINE BAR 5 OF XLAPPINJ_JMN PROMPT '5. Laporan Jaminan Blm dimbil'
 DEFINE BAR 6 OF XLAPPINJ_JMN PROMPT '6. Agunan Titipan Masuk'
 DEFINE BAR 7 OF XLAPPINJ_JMN PROMPT '7. Agunan Titipan Keluar'
 DEFINE BAR 8 OF XLAPPINJ_JMN PROMPT '8. Saldo Agunan Titipan'
 DEFINE BAR 9 OF XLAPPINJ_JMN PROMPT '9. Rekap Agunan Harian'
 ON SELECTION BAR 1 OF XLAPPINJ_JMN do form pinj_lap_agunan with 11
 ON SELECTION BAR 2 OF XLAPPINJ_JMN do form pinj_lap_agunan with 12
 ON SELECTION BAR 3 OF XLAPPINJ_JMN do form pinj_lap_agunan with 13
 ON SELECTION BAR 4 OF XLAPPINJ_JMN do form pinj_lap_agunan with 14
 ON SELECTION BAR 5 OF XLAPPINJ_JMN do form pinj_lap_agunan with 15
 ON SELECTION BAR 6 OF XLAPPINJ_JMN do form pinj_lap_agunan with 16
 ON SELECTION BAR 7 OF XLAPPINJ_JMN do form pinj_lap_agunan with 17
 ON SELECTION BAR 8 oF XLAPPINJ_JMN do form pinj_lap_agunan with 18
 ON SELECTION BAR 9 oF XLAPPINJ_JMN do form pinj_lap_agunan with 19
 
 
 ON SELECTION BAR 6 OF XLAPPINJAMAN do form pinj_lap with 6
 
 ON SELECTION BAR 7 OF XLAPPINJAMAN do form pinj_lap with 7
 ON SELECTION BAR 8 OF XLAPPINJAMAN do form pinj_lap with 8
 
 ON BAR 9 OF XLAPPINJAMAN ACTIVATE POPUP XLAPPINJ_NPL
...
*!*	 DEFINE BAR 6 OF XLAPPINJ_NPL PROMPT '6. Rekap NPL Per Sektor Ekonomi'
 ON SELECTION BAR 1 OF XLAPPINJ_NPL do form pinj_lap with 15
...
*!*	 ON SELECTION BAR 6 OF XLAPPINJ_NPL do form pinj_lap with 12
 ...
 ON SELECTION BAR 10 OF XLAPPINJAMAN do form pinj_lap with 17
 ON SELECTION BAR 11 OF XLAPPINJAMAN do form pinj_lap with 10
 ON SELECTION BAR 12 OF XLAPPINJAMAN do form pinj_lap with 12
 ON SELECTION BAR 13 OF XLAPPINJAMAN do form pinj_lap with 19
 ON SELECTION BAR 14 OF XLAPPINJAMAN do form pinj_lap with 14
 ON SELECTION BAR 15 OF XLAPPINJAMAN do form pinj_lap with 23
 ON SELECTION BAR 16 OF XLAPPINJAMAN do form pinj_lap with 33
 ON SELECTION BAR 17 OF XLAPPINJAMAN do form pinj_lap with 44
 
* ON SELECTION BAR 11 OF XLAPPINJAMAN do form pinj_lap with 11
 ...
 ON BAR 7 OF XREPORT ACTIVATE POPUP XLAPSIMPATA
 DEFINE POPUP XLAPSIMPATA COLOR SCHEME 4 SHADOW MARGIN RELATIVE 
 DEFINE BAR 1 OF XLAPSIMPATA PROMPT '1. Laporan Pembukaan rekening Baru'
 DEFINE BAR 2 OF XLAPSIMPATA PROMPT '2. Laporan Mutasi SIMPATA/Transaksi Harian'
 DEFINE BAR 3 OF XLAPSIMPATA PROMPT '3. Laporan Nominatif SIMPATA'
 DEFINE BAR 4 OF XLAPSIMPATA PROMPT '4. Laporan Penutupan SIMPATA'
 DEFINE BAR 5 OF XLAPSIMPATA PROMPT '5. Laporan SIMPATA Keluar'
 DEFINE BAR 6 OF XLAPSIMPATA PROMPT '6. Laporan SIMPATA Terbesar '
 DEFINE BAR 7 OF XLAPSIMPATA PROMPT '7. Laporan Pajak Simpata'
 DEFINE BAR 8 OF XLAPSIMPATA PROMPT '8. Laporan RBB Simpata'
 
 ON SELECTION BAR 1 OF XLAPSIMPATA do form simp_lap with 1,1
 ON SELECTION BAR 2 OF XLAPSIMPATA do form simp_lap with 2,1
 ON SELECTION BAR 3 OF XLAPSIMPATA do form simp_lap with 3,1
 ON SELECTION BAR 4 OF XLAPSIMPATA do form simp_lap with 4,1
 ON SELECTION BAR 5 OF XLAPSIMPATA do form simp_lap with 9,1  && 5 aslinya
 ON SELECTION BAR 8 OF XLAPSIMPATA do form simp_lap with 5,1
 ...
 DEFINE BAR 4 OF XPROSES PROMPT '4. Proses Hitung Ulang Saldo S M B & SIMPATA' COLOR SCHEME 3
 DEFINE BAR 5 OF XPROSES PROMPT '5. Proses Hitung Ulang Simp Anggota(Pokok,Wajib, Swk, Lain 2' COLOR SCHEME 3
 DEFINE BAR 6 OF XPROSES PROMPT '6. Proses Hitung Ulang Saldo Pinjaman' COLOR SCHEME 3
 DEFINE BAR 7 OF XPROSES PROMPT '7. Proses Hitung Ulang Saldo Inventaris' COLOR SCHEME 3
 DEFINE BAR 8 OF XPROSES PROMPT '\-'
 DEFINE BAR 9 OF XPROSES PROMPT '8. ACC Pengeluaran' SKIP FOR  .NOT. IJINACC() COLOR  ;
      SCHEME 3
 DEFINE BAR 10 OF XPROSES PROMPT '\-'
 DEFINE BAR 11 OF XPROSES PROMPT '9. Verifikasi Proses Harian' SKIP FOR  .NOT. IJINACC()  ;
      COLOR SCHEME 3
 DEFINE BAR 12 OF XPROSES PROMPT '\-'
 DEFINE BAR 13 OF XPROSES PROMPT '10. Proses Tutup Buku' SKIP FOR  .NOT. IJINACC() COLOR  ;
      SCHEME 3
 DEFINE BAR 14 OF XPROSES PROMPT '11. Batal Proses Tutup Buku' SKIP FOR  .NOT. IJINACC()  ;
      COLOR SCHEME 3
  DEFINE BAR 15 OF XPROSES PROMPT '\-'
 DEFINE BAR 16 OF XPROSES PROMPT '12. Proses Perhitungan SHU' SKIP FOR  .NOT. IJINACC() COLOR  SCHEME 3    
 ...
 ON SELECTION BAR 6 OF XPROSES do form proses_cekpiutang
 ON SELECTION BAR 7 OF XPROSES do form proses_cekinvent
 ON SELECTION BAR 9 OF XPROSES do form acc
 ON SELECTION BAR 11 OF XPROSES do form acc_harian1
 ON SELECTION BAR 13 OF XPROSES do form proses_tutupbuku
 ON SELECTION BAR 14 OF XPROSES do form proses_bataltutup
 ON SELECTION BAR 16 OF XPROSES do form angg_shu_proses
 ...
 DEFINE BAR 4 OF XUTIL PROMPT 'Cek Transaksi' COLOR SCHEME 3
 ON SELECTION BAR 4 OF XUTIL do form cek_transaksi
*!*	 DEFINE BAR 5 OF XUTIL PROMPT 'Perbaikan Mutasi Keanggotaan' COLOR SCHEME 3
*!*	 ON SELECTION BAR 5 OF XUTIL do form a_perbaikan_anggota
*!*	 DEFINE BAR 6 OF XUTIL PROMPT 'Cek Transaksi' COLOR SCHEME 3
*!*	 ON SELECTION BAR 6 OF XUTIL do form cek_transaksi   
  DEFINE BAR 5 OF XUTIL PROMPT 'Perbaikan - Perbaikan' COLOR SCHEME 3
	 ON BAR 5 OF XUTIL ACTIVATE POPUP XUTIL_PERBAIKAN
	 DEFINE POPUP XUTIL_PERBAIKAN COLOR SCHEME 4 SHADOW MARGIN RELATIVE 
	 DEFINE BAR 1 OF XUTIL_PERBAIKAN PROMPT '1. Perbaikan Transaksi Simpanan'
	 DEFINE BAR 2 OF XUTIL_PERBAIKAN PROMPT '2. Perbaikan Mutasi Keanggotaan'
	 DEFINE BAR 3 OF XUTIL_PERBAIKAN PROMPT '3. Perbaikan Mutasi Pinjaman'
   *  DEFINE BAR 4 OF XUTIL_PERBAIKAN PROMPT '4. Perbaikan simp. wajib'
     
	 ON SELECTION BAR 1 OF XUTIL_PERBAIKAN do form a_perbaikan_simpanan
	 ON SELECTION BAR 2 OF XUTIL_PERBAIKAN do form a_perbaikan_anggota
	 ON SELECTION BAR 3 OF XUTIL_PERBAIKAN do form proses_cekpiutang
*	 ON SELECTION BAR 4 OF XUTIL_PERBAIKAN do form a_perbaikan_simwajib
	 
 DEFINE BAR 6 OF XUTIL PROMPT 'Pengaturan Lainnya' COLOR SCHEME 3
	 ON BAR 6 OF XUTIL ACTIVATE POPUP XUTIL_LAINNYA
	 ...
	 DEFINE BAR 2 OF XUTIL_LAINNYA PROMPT '2. Proses Pelunasan Pinjaman'
	 DEFINE BAR 3 OF XUTIL_LAINNYA PROMPT '3. Proses Tanggal BHT'
	 DEFINE BAR 4 OF XUTIL_LAINNYA PROMPT '4. Proses Isi Nama & kode Colektor'
	 DEFINE BAR 5 OF XUTIL_LAINNYA PROMPT '5. Proses Kroscek Angsuran - Col'
	 DEFINE BAR 6 OF XUTIL_LAINNYA PROMPT '6. Proses Kroscek Simpanan - Col'
	 DEFINE BAR 7 OF XUTIL_LAINNYA PROMPT '7. Proses Isi tgl valuta yg kosong'
	 DEFINE BAR 8 OF XUTIL_LAINNYA PROMPT '8. Proses Kroscek Turun Jasa'
	 DEFINE BAR 9 OF XUTIL_LAINNYA PROMPT '9. Proses Kroscek Jadwal pinjaman'
	 DEFINE BAR 10 OF XUTIL_LAINNYA PROMPT '10. Proses Update Jaminan pinjaman'
	 ...
	 ON SELECTION BAR 4 OF XUTIL_LAINNYA do form form_isinama
	 ON SELECTION BAR 5 OF XUTIL_LAINNYA do form form_cekangsur
	 ON SELECTION BAR 6 OF XUTIL_LAINNYA do form form_ceksimpan
	 ON SELECTION BAR 7 OF XUTIL_LAINNYA do form form_cekdrop
	 ON SELECTION BAR 8 OF XUTIL_LAINNYA do form form_turunjasa
	 ON SELECTION BAR 9 OF XUTIL_LAINNYA do form form_cekjadwal
	 ON SELECTION BAR 10 OF XUTIL_LAINNYA do form proses_isitungakan
 DEFINE BAR 7 OF XUTIL PROMPT 'Setting Default Printer' COLOR SCHEME 3
 ON SELECTION BAR 7 OF XUTIL do form setting_printer

 DEFINE BAR 8 OF XUTIL PROMPT 'Perbaikan Data' COLOR SCHEME 3
 ON SELECTION BAR 8 OF XUTIL do form a_perbaikan_table

 DEFINE BAR 9 OF XUTIL PROMPT '\-'
 DEFINE BAR 10 OF XUTIL PROMPT 'Backup databased' COLOR SCHEME 3
 ON SELECTION BAR 10 OF XUTIL do form form_backupdata  
 DEFINE BAR 11 OF XUTIL PROMPT 'Restore databased' COLOR SCHEME 3
 ON SELECTION BAR 11 OF XUTIL do form proses_restore 
 DEFINE BAR 12 OF XUTIL PROMPT '\-'
 DEFINE BAR 13 OF XUTIL PROMPT 'Migrasi Data' COLOR SCHEME 3
 ON SELECTION BAR 13 OF XUTIL do form migrasi  
 DEFINE BAR 14 OF XUTIL PROMPT 'Migrasi Inventaris' COLOR SCHEME 3
 ON SELECTION BAR 14 OF XUTIL do form form_inpexcel 
*!*		 ON BAR 14 OF XUTIL ACTIVATE POPUP XUTIL_ANDROID
*!*		 DEFINE POPUP XUTIL_ANDROID COLOR SCHEME 4 SHADOW MARGIN RELATIVE 
*!*		 DEFINE BAR 1 OF XUTIL_ANDROID PROMPT '1. Data Anggota '
*!*		 DEFINE BAR 2 OF XUTIL_ANDROID PROMPT '2. Data Master Pinjaman '
*!*		 DEFINE BAR 3 OF XUTIL_ANDROID PROMPT '3. Data Mutasi Pinjaman'
*!*		 DEFINE BAR 4 OF XUTIL_ANDROID PROMPT '4. Data Master Simpanan'
*!*		 DEFINE BAR 5 OF XUTIL_ANDROID PROMPT '5. Data Mutasi Simpanan'
	
*!*		 ON SELECTION BAR 1 OF XUTIL_ANDROID do form form_resetproses
*!*		 ON SELECTION BAR 2 OF XUTIL_ANDROID do form form_AutoLunas
*!*		 ON SELECTION BAR 3 OF XUTIL_ANDROID do form form_AutoTutup
*!*		 ON SELECTION BAR 4 OF XUTIL_ANDROID do form form_isinama
*!*	 
*!*	  ON SELECTION BAR 4 OF XUTIL_ANDROID do form form_isinama
*!*	 
 *DEFINE BAR 14 OF XUTIL PROMPT 'Migrasi Android' COLOR SCHEME 3
 *ON SELECTION BAR 14 OF XUTIL do form migrasi  
